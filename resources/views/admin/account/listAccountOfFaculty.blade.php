                ...
                <div class="row">
                    <div class="card col-md-12">
                        <h5 class="card-header">
                            <div class="row">
                                <div class="col">Khoa {{$facultyById->faculty_name}} \ Tài Khoản quản trị</div>
                                ...
                                <div class="col" align="right">
                                    ...
                                    @include('admin.account.addAccountFaculty')

                                </div>
                            </div>
                        </h5>
                        <div class="card-body" id="Show_all_account_faculty">
...
@section('js-index')
    <script>
        ...
        function fetchAll(){
            ...
            $.ajax({
                url: '{{route('accounts.fetchAccountFaculty')}}',
                method: 'get',
                data: {
                    faculty_id:faculty_id
                },
                success: function (res){
                    $('#Show_all_account_faculty').html(res);
                    $("table").DataTable({
                        order: [0, 'desc']
                    })
                }
        ...
        function deleteItem(id){
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '{{ route('accounts.deleteAccountFaculty') }}',
                        method: 'post',
                        data:{
                            id: id,
                            _token: '{{ csrf_token() }}',
