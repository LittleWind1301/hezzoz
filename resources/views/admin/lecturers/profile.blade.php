                        ...
                        <form action="">
                            <div class="form-row">
                                <div class="col-md-4">
                                    ...
                                    <input disabled type="text" class="form-control" value="{{$userProfile->lecturers_name}}">
                                </div>
                                <div class="col-md-4">
                                    <label for="">Mã giảng viên</label>
                                    <input disabled type="text" class="form-control" value="{{$userProfile->lecturers_id}}">
                                </div>
                                <div class="col-md-4">
                                    <label for="">Bộ môn</label>
                                    <input disabled type="text" class="form-control" value="{{$course->course_name}}">
                                </div>
                            </div>
